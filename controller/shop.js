...
router.post('/create-shop', catchAsyncErrors(async (req, res, next) => {
  try {
    ...
    const verificationLink = `https://villaja-server.onrender.com/api/shop/verify-email/${newSeller._id}/${newSeller.emailVerificationCode}`;
        ...
        <body>
          <div style="text-align: left; background-color: #f3f3f3; padding: 20px;">
            ...
            <p>
             ...
             <p>
             By the way your shop has been created, yay!🙂
             </p>
             <p>
...
router.post('/forgot-password', catchAsyncErrors(async (req, res, next) => {
  try {
    ...
    const resetPasswordLink = `https://villaja-server.onrender.com/api/shop/reset-password/${resetToken}`;
  ...
  try {
    ...
    <body style="font-family: Arial; padding: 20px; margin-top:30px;">
      ...
      <center>
        ...
        <form action="https://villaja-server.onrender.com/api/shop/reset-password" method="post" style="max-width: 400px; margin: 0 auto;">
